...
export const metadata: Metadata = {
  ...
  description: "🎵 Игра '3 сентября' по мотивам песни Михаила Шафутинского! Лови летающие листки календаря в увлекательной онлайн игре. Мем 3 сентября, я календарь перевернул мем, Шафутинский мем ! Бесплатная игра про 3 сентября с Шафутинским. Играй прямо в браузере!",
  ...
  openGraph: {
    ...
    description: "🎵 Игра '3 сентября' по мотивам песни Михаила Шафутинского! Лови летающие листки календаря в увлекательной онлайн игре. Мем 3 сентября, я календарь перевернул мем, Шафутинский мем !",
    type: "website",
    locale: "ru_RU",
